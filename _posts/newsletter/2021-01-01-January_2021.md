...
The argument that identification requirements improve financial inclusion directly contradicts a previous BIS study (which he cites) that states CBDCs tied to an identity scheme would be "good" for "law enforcement," but not necessarily for the unbanked.
{: style="text-align: justify;"}
