...
However, their provision of this service is not mentioned at all in their [transparency report](https://archive.ph/CbvO5). Since the use of blockchain surveillance tools affect the financial privacy of their customers (as well as non-Coinbase customers), and the goal of their report is supposedly to provide "a view into how government policies and actions intersect with customer privacy," I would argue that including a list of the agencies and offices subscribed to Coinbase Tracer is more than appropriate. As you have seen in my newsletter, these records are often public anyway!
{: style="text-align: justify;"}
