...
Still, according to Dutch engineer and financial history consultant [Simon Lelieveldt](https://www.simonl.org/), the ambiguity of the language is concerning. While they may not explicitly ban the use of non-custodial wallets, "[the FATF is pushing countries to not license/register companies if they allow communications with unhosted/anonymous wallets](the FATF is pushing countries to not license/register companies if they allow communications with unhosted/anonymous wallets.)." As I highlighted in March, this isolation / exclusion strategy was already in their [new draft](https://web.archive.org/web/20210319175919/http://www.fatf-gafi.org/media/fatf/documents/recommendations/March%202021%20-%20VA%20Guidance%20update%20-%20Sixth%20draft%20-%20Public%20consultation.pdf).
{: style="text-align: justify;"}
