...
Bitcoin-related websites which support a hidden service version of their website and have enabled Onion-Location include [Blockchair](https://blockchair.com/), [Blockstream.info](https://blockstream.info/), [Mempool.Space](https://mempool.space/), [RoninDojo](https://ronindojo.io/), and [Wasabi Wallet](https://wasabiwallet.io/).
...
## July 29th - TAPROOT ACTIVATION

The [Bitcoin Core PR Review Club](https://bitcoincore.reviews/17977), hosted by [John Newberry](https://twitter.com/jfnewbery), held their third meeting to discuss the implementation of the Schnorr and Taproot BIPs: [340](https://github.com/bitcoin/bips/blob/master/bip-0340.mediawiki), [341](https://github.com/bitcoin/bips/blob/master/bip-0341.mediawiki), and [342](https://github.com/bitcoin/bips/blob/master/bip-0342.mediawiki). There are currently [several proposals](https://en.bitcoin.it/wiki/Taproot_activation_proposals) for activating Taproot as a soft fork.
