...
4. [Coinbase Contracted with Secret Service, IRS]()
...
On July 14th, a [subscription purchase order](https://web.archive.org/web/20200716163836/https://beta.sam.gov/awards/91148315%2BAWARD?keywords=coinbase&sort=-modifiedDate&index=&is_active=true&page=1) from the [IRS](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/June_2020/#june-5th---coinbase-offers-blockchain-surveillance-to-irs-dea) has since been published, and the contract is listed as "signed." The action obligation value is $124,950, and the total contract value is noted as $237,405.
{: style="text-align: justify;"}
