...
:information_source: Check out the [Bitcoin Optech Schnorr Taproot Workshop](https://bitcoinops.org/en/schorr-taproot-workshop/) to learn more about Schnorr signatures.
{: .notice--success}
