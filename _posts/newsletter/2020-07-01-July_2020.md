...
The same IRS division we highlighted in [the last issue](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/June_2020/#june-5th---coinbase-offers-blockchain-surveillance-to-irs-dea) published a [request for information](https://archive.is/Vrcce) regarding "systems that will allow developers and testers to conduct investigative research of distributed ledger transactions involving privacy cryptocurrency coins," "Layer 2 off-chain protocol networks," "Side-chains," and "tracing challenges following the integration of the Schnorr Signature algorithm."
