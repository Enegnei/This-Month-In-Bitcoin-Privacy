...
Their concern is well-founded, given that depending on the permissions that these apps enable, [Plaid](https://plaid.com/legal/#end-user-privacy-policy) lists "the following types of identifiers, commercial information, and other personal information" that they collect "in general":
