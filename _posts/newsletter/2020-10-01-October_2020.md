...
In [TMIBP03](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/August_2020/#august-5th---payjoin-support-in-wasabi-and-joinmarket), I highlighted progress in adding BIP-78 PayJoin support. This month, as per their [v0.7.1 release](https://github.com/JoinMarket-Org/joinmarket-clientserver/releases/tag/v0.7.1), JoinMarket has also enabled receiver support.
{: style="text-align: justify;"}
