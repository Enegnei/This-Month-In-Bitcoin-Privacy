...
6. FATF Report on 'Red Flag Indicators'
7. Fidelity's Crypto Privacy Conference
8. Wasabi Wallet Developer Meeting
9. Blacklight Website Privacy Inspector
10. Samourai Opens Beta Testing For Soroban

*Due to my busy schedule, this month's issue of the newsletter will have fewer stories and be more concise than usual.*
...
Last month, the [**Tor Project**](https://blog.torproject.org/stop-the-onion-denial) had indicated that they were also exploring using anonymous tokens / credentials to "prioritize good clients over malicious clients when a denial of service attack is happening," as well as to "reward trusted users with tokens that can later be used to regain access."
{: style="text-align: justify;"}
