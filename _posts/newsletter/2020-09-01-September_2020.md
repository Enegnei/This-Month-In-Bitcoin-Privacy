...
[Fully Noded](https://twitter.com/FullyNoded/status/1310075096950648832) published [a video](https://youtu.be/O_MS9LD9otI) on how to manually create your own CoinJoin-type transaction using [Partially Signed Bitcoin Transactions](https://bitcoinops.org/en/topics/psbt/) (PSBTs) on the Bitcoin testnet. Towards the end, they show that Blockstream.info's privacy analysis designated it as "[possibly a CoinJoin transaction](https://blockstream.info/testnet/tx/772a056c8cd2ee46e72f8d1560c6d7170cfacf80872cf129b4e05e14b5a95566)." The [Boltzmann](https://code.samourai.io/oxt/boltzmann) score also returned zero deterministic links.
{: style="text-align: justify;"}
