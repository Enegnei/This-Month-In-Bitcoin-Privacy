...
+ [Zcash Foundation](https://themarkup.org/blacklight/?url=www.zfnd.org): Interestingly, there is a third-party cookie from Stripe, and they also appear to be allowing Stripe to engage in [canvas fingerprinting](https://twitter.com/J9Roem/status/1310243940663255042). A self-loaded key logging script tracks the "email field."
