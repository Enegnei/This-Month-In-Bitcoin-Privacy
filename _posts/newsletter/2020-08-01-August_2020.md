...
As I covered in [TMIBP01](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/June_2020/#june-21st---introducing-joininbox), JoinInBox is a terminal-based graphical menu for the CoinJoin implementation [JoinMarket](https://github.com/JoinMarket-Org/joinmarket-clientserver). While JoinMarket have had [their own GUI](https://github.com/JoinMarket-Org/joinmarket-clientserver/blob/master/docs/JOINMARKET-QT-GUIDE.md) for four years now, he has been optimizing this menu as part of an effort to expand the supported application suite for [RaspiBlitz](https://shop.fulmo.org/raspiblitz/). Adam Gibson has also been working on [supporting maker functions for GUI-only users](https://github.com/JoinMarket-Org/joinmarket-clientserver/pull/487) and recently [released](https://x0f.org/@waxwing/104711319655673159) a [JoinMarket Control Center prototype](https://github.com/JoinMarket-Org/jmcontrolcenter/releases/tag/v0.0.1dev) with "richer UI" and "easier cross platform binary distribution."
{: style="text-align: justify;"}
