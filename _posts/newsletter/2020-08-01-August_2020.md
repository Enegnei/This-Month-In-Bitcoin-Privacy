...
'ZmnSCPxj' replied that the maker / taker relationship in CoinSwaps potentially "[has a massive advantage over CoinJoin](https://lists.linuxfoundation.org/pipermail/bitcoin-dev/2020-August/018106.html)."
...
[Nadav Kohen](https://twitter.com/nadav_kohen) commented that some of the "[complexity more or less goes away once we have Schnorr signatures and can use MuSig with adaptor signatures](https://lists.linuxfoundation.org/pipermail/bitcoin-dev/2020-August/018108.html)."
