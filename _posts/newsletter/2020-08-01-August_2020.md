...
Later in the month, he [expressed concern](https://twitter.com/renepickhardt/status/1298918019159207942) that "there are so many misconceptions about the privacy of Lightning in the wild for which often just the opposite seems to be true," and worried "we won't be able to fix that" in '[Mastering the Lightning Network](https://github.com/lnbook/lnbook).'
