...
On August 20th, JoinMarket released [0.7.0](https://github.com/JoinMarket-Org/joinmarket-clientserver/releases/tag/v0.7.0), which also supports [PayJoin](https://github.com/JoinMarket-Org/joinmarket-clientserver/blob/master/docs/release-notes/release-notes-0.7.0.md) in the command line and GUI.
