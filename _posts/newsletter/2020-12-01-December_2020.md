...
[**Coinkite**](https://twitter.com/COLDCARDwallet/status/1339299857509609474) published another installment in their educational video series, in collaboration with '[Keep It Simple Bitcoin](https://twitter.com/KISBitcoin)': "[How To Use JoinMarket - Bitcoin Privacy Software](https://youtu.be/9COdlsh4inY)." It covers installation via the command line, setup, participating in CoinJoins, and the yield generator.
{: style="text-align: justify;"}
...
> We try to take and store as little as possible, but we are obliged to register and store some of the data entrusted with us by our customers... The tax authorities will ask us how many devices we sold, to whom, in which states, etc. which is why we store this data.
...
In [a long goodbye letter](https://blog.bitbargain.com/post/638504004285054976/goodbye) published on Christmas Day, the CEO wrote about his experience running the platform since 2012, and why "it did not feel right at all" to continue operating. He also commented on the role and effectiveness of blockchain surveillance companies: "Most of the requests we did not comply with originated from blockchain analysis based information."
{: style="text-align: justify;"}
