...
> We try to take and store as little as possible, but we are obliged to register and store some of the data that is entrusted with us by our customers... The tax authorities will ask us how many devices we sold, to whom, in which states, etc. which is why we store this data.
...
:information_source: If you are new to CoinJoins and Whirlpool specifically, see [Bitcoin Q+A](https://twitter.com/BitcoinQ_A/status/1292095078752813059)'s user guide "[Whirlpool + Postmix Spending FAQ](https://www.bitcoinqna.com/post/whirlpool-faq)."
{: .notice--success}
