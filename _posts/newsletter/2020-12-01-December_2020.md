...
10. Ledger Data Dump
11. Financial Cancel Culture
12. Release Candidate Testing
13. Farcaster: Atomic Swaps with Monero
14. Merry Mixmas
15. "A Best Guess": BitBargin Closes
...
[**Samourai Wallet**](https://twitter.com/SamouraiWallet/status/1342044130206244865) is offering a 50% [discount code](https://support.samourai.io/article/88-add-a-discount-code-scode-to-whirlpool) on all [Whirlpool](https://www.samouraiwallet.com/whirlpool) mixing fees until January 1st 2021.
{: style="text-align: justify;"}

:information_source: If you are new to Whirlpool, see [Bitcoin Q+A](https://twitter.com/BitcoinQ_A/status/1292095078752813059)'s user guide "[Whirlpool + Postmix Spending FAQ](https://www.bitcoinqna.com/post/whirlpool-faq)."
{: .notice--success}

## December 26th - "A BEST GUESS": BITBARGAIN CLOSES

The U.K.-based marketplace [**BitBargain**](https://twitter.com/BitBargain) ceased to allow trading and deposits, following a previously published [closure schedule](https://blog.bitbargain.com/post/636272790445637632/closing-down-before-regulations) that aligned with deadlines for registering (or else) according to the [fifth European anti-money laundering directive](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32018L0843). Withdrawals would still be possible until January 6th 2021. In [a long goodbye letter](https://blog.bitbargain.com/post/638504004285054976/goodbye) published on Christmas Day, the CEO wrote about his experience running the platform since 2012, and why "it did not feel right at all" to continue operating. He also commented on the role and effectiveness of blockchain surveillance companies:
{: style="text-align: justify;"}
