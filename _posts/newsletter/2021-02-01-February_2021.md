...
In [TMIBP07](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/December_2020/#december-10th---the-patriot-act-share-it-all) and [TMIBP08](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/January_2021/), I've followed the proposed rulemaking from the Financial Crimes Enforcement Network (FinCEN) regarding personal and financial information of cryptocurrency users. On February 1st, [Jerry Brito](https://www.coincenter.org/people/jerry-brito/), and [Peter van Valkenburgh](https://www.coincenter.org/people/peter-van-valkenburgh/) from **Coin Center** gave an update in [episode #25](https://coincenter.simplecast.com/episodes/defi-and-the-sec) of their [Tangents](https://twitter.com/jerrybrito/status/1356320598306205696) podcast. They expected to file some comments on the currency transaction report (CTR) aspect, which they had not done yet, because they see it as "equal treatment."
...
On February 19th, as a [visiting fellow](https://www.aei.org/profile/jim-harper/) at the [American Enterprise Institute](https://twitter.com/AEI/status/1364021157339529218) (AEI), Harper published a piece about "[an implicit campaign to make the law recognize and stop presumed bad data practices](https://www.aei.org/technology-and-innovation/should-the-law-recognize-privacy-harms/)."
{: style="text-align: justify;"}
