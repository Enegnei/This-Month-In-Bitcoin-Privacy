...
Graphic designer [**@artdesignbySF**](https://twitter.com/artdesignbySF/status/1363938123143667716), who also helped with the [BTCPay server integration](https://hrf.org/donate-bitcoin/) for the **Human Rights Foundation** (HRF), contributed an animated graphic for the occasion.
