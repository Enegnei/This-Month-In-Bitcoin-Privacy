...
:information_source: Find out about other changes and bug fixes in Bitcoin Core releases [here](https://bitcoincore.org/en/releases/). Check out the [Bitcoin Optech Newsletter](https://bitcoinops.org/en/newsletters) for summaries of recent technical developments beyond Bitcoin privacy.
{: .notice--success}
