...
It is important to understand how this improves user privacy and how it doesn't. Using Tor can protect against network observers attempting to link off-chain data points, such as IP address and geographic location, with on-chain data. Unless you use [your own node](https://github.com/trezor/blockbook), Trezor's services could still correlate your addresses together if you are querying the balances from the same network identity. Tor will also _not_ obscure your transaction history on the blockchain or fix poor coin management practices.
{: style="text-align: justify;"}
