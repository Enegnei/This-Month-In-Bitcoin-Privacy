...
9. Digital Currency, Civil Liberties, Mercenaries
...
In [TMIBP04](https://enegnei.github.io/This-Month-In-Bitcoin-Privacy/September_2020/#september-10th---nym-mixnet-test-rewards-in-bitcoin), I pointed out research being conducted by the [**Tor Project**](https://www.torproject.org) into using anonymous tokens, for the purpose of defending against denial-of-service (DoS) attacks. When the nonprofit announced their annual "[State of the Onion](https://twitter.com/torproject/status/1326296867009818626)" presentation, this was one of the topics in [the agenda](https://blog.torproject.org/state-of-the-onion-2020).
{: style="text-align: justify;"}
