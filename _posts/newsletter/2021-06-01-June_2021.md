...
1. Bitcoin Design Guide
2. Removing Tor V2 Support
3. Chaincase PayJoin Demo
4. Improving Off-Chain Protocol Privacy
5. Taproot Locked In
6. Privacy in Trezor Suite
7. Ledger Data Dump Update
8. Coverting CoinJoined Coins to Cash
9. FATF Delays Finalising Guidance
...
Gould was also interviewed by [Max Hillebrand](https://twitter.com/HillebrandMax/status/1406658352180985866) for [episode #19](https://youtu.be/VAWeCdKrJsM) of "[Join the Wasabikas](https://podcastindex.org/podcast/2415622)" to talk about his background with Tumblebit and HiddenWallet, the user experience of Chaincase, running Tor on iOS, and how to make privacy features accessible.
{: style="text-align: justify;"}
...
:information_source: For more on this topic, see this guest-post by '[pretyflaco](https://twitter.com/_pretyflaco/status/1399481746517856258)' on "[Regulatory attention on Bitcoin & privacy techniques to counter](https://blog.fulmo.org/intrusive-regulatory-attention-on-bitcoin-and-privacy-enhancing-techniques-to-counter/)," published by [**Fulmo**](https://twitter.com/fulmolightning).
{: .notice--success}
