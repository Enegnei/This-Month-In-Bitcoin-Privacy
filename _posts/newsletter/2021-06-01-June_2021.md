...
> 
> In April 2021, Bitcoin Core 0.21.1 was released that included the now finalized proposal, including activation mechanism and parameters. The chosen mechanism allowed for a short period of time during which miners can signal readiness. 90% within a window would trigger lock-in.
> 
> Today, that 90% was reached, and the deployment will transition inevitably into locked-in state at the end of this retargetting window. Activation will follow automatically, at block 709632 in November 2021. After that, the rules will be enforced on mainnet, and available for use. Thanks to everyone who has helped us get this far - contributors to the BIPs, to the reference code, reviewers of those, .... But this is also just the beginning. The real work will be in the ecosystem of wallets and other applications adopting changes to make use of Taproot.
