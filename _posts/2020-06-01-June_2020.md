...
They argue that, similar to CoinJoins, this would help with obfuscating "payment sender/receiver linkability for an on-chain observer," though pools will want to employ "extra Sybil-resistance" measures, such as requiring some out-of-band communication to join, or options proposed for CoinJoin systems, such as fidelity bonds and [proof of discrete log equivalence](https://joinmarket.me/blog/blog/poodle/) (PoDLE) commitments.
