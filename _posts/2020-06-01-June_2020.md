...
I participated in [long group discussion](https://youtu.be/U6WdW0Zbo9U) with the three authors about how WabiSabi works and Bitcoin privacy in general. About [halfway through](https://youtu.be/U6WdW0Zbo9U?t=5123), I asked about how they decided on the name 'WabiSabi.' Ádám said that they were originally going to call it "Confidential CoinJoin Construction," and István explained the meaning of the Japanese term [*wabi-sabi*](https://en.wikipedia.org/wiki/Wabi-sabi) (侘寂).
{: style="text-align: justify;"}
