...
**Chainalysis** published an advertorial for their partnership with Fireblocks, disguised as "[The Ultimate Guide to Security and Compliance for Cryptocurrency Businesses](https://web.archive.org/web/20200625154212/https://blog.chainalysis.com/reports/ultimate-guide-security-compliance-cryptocurrency-businesses-exchanges)." The first half looks at three categories of compliance that cryptocurrency businesses may need to deal with: Know Your Customer (KYC), transaction monitoring, and responding to risky activity, which they define as "activity indicative of money laundering, terrorism financing, or other forms of financial crime." The second half summarises popular "attack vectors," or rather the targets of them, based on prior examples of compromises. They state that such awareness is necessary because "we in the industry need to make sure cryptocurrency has consumer protection measures and compliance processes comparable to what users are accustomed to getting when dealing in fiat currencies."
