...
Towards the end of the debate, Robinson stated, "I absolutely do think there is a moral responsibility on companies like ours to decide who we should and should not be providing these capabilities to so we for example would never provide it them to any kind of authoritarian government." It is curious that, after trying to separate the 'capabilities' of Elliptic from the actions of their government clients, he now acknowledges a moral responsibility for those results. When Gladstein asks whether they would take the U.S. government as a client, he responds, "I mean, there's always gray areas, right? We have to decide on the case-by-case basis." {: style="text-align: justify;"}
