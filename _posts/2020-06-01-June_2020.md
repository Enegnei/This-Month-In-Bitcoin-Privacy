...
Ádám Ficsór, [István András Seres](https://twitter.com/Istvan_A_Seres), and '[NothingMuch](https://twitter.com/mHaGqnOACyFm0h5)' Yuval Kogman released [the draft](https://github.com/zkSNACKs/WabiSabi) for a new variable-amount Chaumian CoinJoin protocol dubbed "WabiSabi." The paper states that it will be utilizing "a keyed-verification anonymous credentials (KVAC) scheme" and "homomorphic value commitments."
